...
$(document).ready(function() {
    $('body').on('click', '.getChatWindows', function(e) {
        ...
        console.log("Receiver ID clicked: ", receiver_id); // Debugging
        $('#getReceiverIDDynamic').val(receiver_id); // Update the hidden input field
        console.log("Updated Receiver ID: ", $('#getReceiverIDDynamic').val()); // Debugging
        ...
        $.ajax({
            ...
            error: function(data) {
                console.log("AJAX Error: ", data); // Debugging
            }
        });
    });
});
    ...
    $('body').on('click', '#getSearchUser', function(e) {
        ...
        $.ajax({
            ...
            error: function(data) {
                console.log("Search User AJAX Error: ", data); // Debugging
            }
        });
    });
});
