...
class FeesCollectionController extends Controller
{
    ...
    // CollectFeesStudentPaymentParent
    ...
    public function PaymentSuccessStripeParent($student_id, Request $request){
        ...
        if (!$trans_id) {
            \Log::error('Invalid session ID. Please try again.');
            return redirect('parent/my_student/fees_collection/'.$student_id)->with('error', "Invalid session ID. Please try again.");
        }
